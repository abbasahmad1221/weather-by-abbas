...
return ( <main className="min-h-screen bg-slate-50"> <section className="bg-storm-gradient"> <div className="mx-auto max-w-6xl px-4 py-12 text-center sm:py-16"> <h1 className="font-display text-3xl font-extrabold text-white sm:text-4xl">
🌦️ Live Weather </h1>
